...
namespace SignTest.API
{
    ...
    {
        public static string AdminEmail = "1214818026@qq.com";
        ...
        public static string GetTieBa_NewURL = "https://tieba.baidu.com/mo/q/newmoindex";                  //获取关注的吧，这个好用！
        ...
        public static string GetInfo_URL = "http://ce.baidu.com/site/getUserProfile";                       //获取用户名和头像(这个接口很慢！！！不建议用！！！)
        ...
        public static string RemoveFans_URL = "http://tieba.baidu.com/i/commit";                               //移除粉丝
