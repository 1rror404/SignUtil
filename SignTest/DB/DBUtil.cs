...
namespace 签到所有吧
{
    class DBUtil
    {
        public static string connectionString = "server=.;database=Sign;uid=sa;pwd=123";
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataSet Query(string SQLString, Hashtable args)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    if (args != null) SetArgs(SQLString, args, cmd);
